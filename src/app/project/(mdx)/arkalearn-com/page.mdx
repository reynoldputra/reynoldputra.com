...
- **Next-Intl** for i18n support. Currently, we implement dynamic translation messages via PayloadCMS. For general translations, we store them in JSON files inside `/messages/(en|id|jp).json`

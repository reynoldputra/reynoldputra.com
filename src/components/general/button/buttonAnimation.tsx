...
export default function ButtonAnimation({
  ...
  return (
    ...
    >
      ...
      <div
        className={
          "z-10 w-0 h-0 group-hover:w-32 group-hover:h-32 transition-all duration-500 rounded-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 " +

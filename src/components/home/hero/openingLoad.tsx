import Terminal from "@/components/general/terminal/terminal";
import TermHeading from "@/components/general/terminal/termHeading";
import TermRegular from "@/components/general/terminal/termRegular";

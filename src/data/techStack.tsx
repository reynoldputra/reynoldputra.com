import TypescriptLogo from "@/assets/logo/typescript";
import JavascriptLogo from "@/assets/logo/javascript";
import CLogo from "@/assets/logo/c";
import FirebaseLogo from "@/assets/logo/firebase";
import LaravelLogo from "@/assets/logo/laravel";
import MongoLogo from "@/assets/logo/mongo";
import MysqlLogo from "@/assets/logo/mysql";
import NestLogo from "@/assets/logo/nest";
import NextLogo from "@/assets/logo/next";
import PhpLogo from "@/assets/logo/php";
import ReactLogo from "@/assets/logo/react";
import VueLogo from "@/assets/logo/vue";
  ...
  language: [
    {
      ...
      logo: (
        <JavascriptLogo className="p-2 transition-all duration-300 svg-stroke change-stroke cursor-pointer" />
      ),
    },
    {
      title: "typescript",
      ...
      logo: (
        <TypescriptLogo className="p-2 transition-all duration-300 svg-stroke change-stroke cursor-pointer" />
      ),
    },
    {
      title: "c",
      ...
      logo: (
        <CLogo className="p-2 transition-all duration-300 svg-stroke change-stroke cursor-pointer" />
      ),
    },
    {
      title: "php",
      ...
      logo: (
        <PhpLogo className="transition-all duration-300 svg-stroke change-stroke cursor-pointer" />
      ),
    },
  ],
  tool: [
    {
      ...
      logo: (
        <LaravelLogo className="p-2 transition-all duration-300 svg-stroke change-stroke cursor-pointer" />
      ),
    },
    {
      title: "react js",
      ...
      logo: (
        <ReactLogo className="p-1 mt-1 transition-all duration-300 svg-stroke change-stroke cursor-pointer" />
      ),
    },
    {
      title: "next js",
      ...
      logo: (
        <NextLogo className="p-2 transition-all duration-300 svg-stroke change-stroke cursor-pointer" />
      ),
    },
    {
      title: "vue js",
      desc: "A JavaScript library for building user interfaces. It's popular for its component-based architecture and virtual DOM, which make it easy to build fast and scalable web applications.",
      logo: (
        <VueLogo className="p-2 transition-all duration-300 svg-stroke change-stroke cursor-pointer" />
      ),
    },
    {
      title: "nest js",
      ...
      logo: (
        <NestLogo className="p-2 transition-all duration-300 svg-stroke change-stroke cursor-pointer" />
      ),
    },
    {
      title: "mysql",
      desc: "A JavaScript library for building user interfaces. It's popular for its component-based architecture and virtual DOM, which make it easy to build fast and scalable web applications.",
      logo: (
        <MysqlLogo className="p-2 pt-3 transition-all duration-300 svg-stroke change-stroke cursor-pointer" />
      ),
    },
    {
      title: "mongo db",
      ...
      logo: (
        <MongoLogo className="p-2 transition-all duration-300 svg-stroke change-stroke cursor-pointer" />
      ),
    },
    {
      title: "firebase",
      ...
      logo: (
        <FirebaseLogo className="p-2 transition-all duration-300 svg-stroke change-stroke cursor-pointer" />
      ),
    },
  ],
};
